...
def MRMinExpand_GMSCR(m, nodelist, D, Data, v, omega, t_max,e):
    n = len(D)
...
if __name__ == '__main__':
    ...
    D *= 1000 # 千米换成米
    path,effective_coverage_rate,onTime_rate,k = MRMinExpand_GMSCR(m,nodelist,D,Data,25,omega,t_max,e) # 此方法最后置空了nodelist
    print('path:', path)
