...
如\figref{fg602}所示，系统界面主要分为主页、数据导入和结果展示三个部分。

\begin{figure}[H]
	\centering
	\includegraphics[width = 1\textwidth]{fg7_zhujiemian}
	\caption{系统主界面}
	\label{fg602}
\end{figure}
而参数设置区域又可以分为整体设置和无人机参数设置两个模块，分别如\figref{fg603}和\figref{fg604}所示：

\begin{figure}[H]
	\centering
	\includegraphics[width = 1\textwidth]{fg8_poi}
	\caption{整体设置界面}
	\label{fg603}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width = 1\textwidth]{fg9_uav}
	\caption{无人机参数设置界面}
	\label{fg604}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 1\textwidth]{fg10_result}
